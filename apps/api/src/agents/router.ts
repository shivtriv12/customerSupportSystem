...
import { z } from "zod"
import { toLlmMessages, type AgentMessage, type RoutingResult } from "@repo/shared"
...
export async function routeMessage(messages: AgentMessage[]): Promise<RoutingResult> {
  try {
