...
-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PROCESSING', 'DISPATCHED', 'DELIVERED', 'CANCELLED');

-- CreateEnum
CREATE TYPE "InvoiceStatus" AS ENUM ('OPEN', 'PAID', 'OVERDUE', 'REFUNDED');
...
CREATE TABLE "Order" (
    ...
    "deliveryStatus" "OrderStatus" NOT NULL,
    "item" TEXT NOT NULL,
